...
private:
	...
	enum _property { NORMAL, BOUNCE, FLOAT, RANDOM, EXPLOSION } particleType; //type of particle to make
	...
	ParticleList* iterator0 = NULL; //iterator of the element before the one currently selected (unused)
	ParticleList* iterator1 = NULL; //iterator of the last added element
	ParticleList* iterator2 = NULL; //iterator of the element to add after the last one added
	ParticleList* iteratorA = NULL; //iterator for general purposes
